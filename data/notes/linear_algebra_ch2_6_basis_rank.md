...
- Example 2.17 백지 분석 (Eq 2.81~2.83):
  ...
  - 계수 행렬 소거 결과 1번째, 2번째, 4번째 열이 피벗 열이 되므로, $\{\mathbf{x}_1, \mathbf{x}_2, \mathbf{x}_4\}$ 가 부분공간 $U$ 의 기저(Basis)가 됩니다!
...
- 대칭성 (Fundamental Theorem of Rank):
  ...
  독립된 열의 개수(Column Rank)와 독립된 행의 개수(Row Rank)는 무조건 정확하게 일치합니다!
