...
MML 교재 2.5절의 **Example 2.9**에서는 $2$차원 공간 $\mathbb{R}^2$ 상의 3개 벡터 $x_1 = \begin{bmatrix} 1 \\\\ 2 \end{bmatrix}, x_2 = \begin{bmatrix} 3 \\\\ 4 \end{bmatrix}, x_3 = \begin{bmatrix} 5 \\\\ 6 \end{bmatrix}$ 의 독립성 판별:
...
MML 교재 2.5절의 **Example 2.10**에서는 $3$차원 벡터 $v_1 = \begin{bmatrix} 1 \\\\ 0 \\\\ 1 \end{bmatrix}, v_2 = \begin{bmatrix} 0 & 1 & 0 \end{bmatrix}^T, v_3 = \begin{bmatrix} 0 \\\\ 0 \\\\ 1 \end{bmatrix}$ 판별:
...
MML 교재 2.5절의 **Example 2.11**에서는 행렬 $V = [v_1, \dots, v_k]$ 의 피벗 개수(Rank)를 이용한 판별 규칙 정립:
